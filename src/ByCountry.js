...
function ByCountry({ page, nextPage, prevPage, country }) {
    ...
    useEffect(() => {
        ...
        fetch(`https://arkakapi.herokuapp.com/https://newsapi-delta.vercel.app/api/news?country=${bycountry}&category&page-Size=5&page=${page}&apiKey=e316f0b03f6943de87c96dca9afde82a`)
            .then(res => {
                if (!res.ok) {
